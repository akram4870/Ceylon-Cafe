...
export default function Home() {
  ...
  <header className="bg-black/80">
    <div className="container mx-auto py-2 px-4 md:px-6 flex flex-col md:flex-row justify-between items-center text-sm">
      {/* Contact Info - Hidden on mobile, visible on md+ screens */}
      ...
      {/* Social Links - Centered on mobile, normal on desktop */}
      <div className="w-full md:w-auto flex justify-center md:justify-start gap-4 py-2 md:py-0">
        <a 
          href="https://www.facebook.com/profile.php?id=61573920290781" 
          target="_blank" 
        ...
        <a 
          href="https://www.instagram.com/ceyloncafevending/" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="hover:text-red-500 transition-colors"
        ...
        <a 
          href="https://www.linkedin.com/company/106711840" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="hover:text-red-500 transition-colors"
          aria-label="LinkedIn"
...
<footer className="bg-zinc-900 text-white border-t border-red-600/30 py-8">
  ...
  <a 
    ...
    target="_blank" 
    rel="noopener noreferrer"
    className="bg-zinc-800 hover:bg-red-600 p-3 rounded-full transition-colors duration-300"
  >
    <Facebook className="h-5 w-5" />
